...
public class RunMatsimUnique {
	...
	public static void main(String[] args) throws IOException {
		...
		if ( args==null || args.length==0 || args[0]==null ){
			config = ConfigUtils.loadConfig( "examples/scenarios/UrbanLine/SuburbanCorex5/config.xml", new MultiModeDrtConfigGroup(),
		...
		config.controler().setOutputDirectory("examples/scenarios/UrbanLine/SuburbanCorex5/output");
		...
		Desktop.getDesktop().open(new File(config.controler().getOutputDirectory() + "/scorestats.png"));
