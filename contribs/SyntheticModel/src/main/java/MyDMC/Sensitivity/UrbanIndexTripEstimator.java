...
public class UrbanIndexTripEstimator extends AbstractTripRouterEstimator {
	@Inject
	public UrbanIndexTripEstimator(TripRouter tripRouter, ActivityFacilities facilities,
