...
public class UrbanIndexTripEstimatorVOT extends AbstractTripRouterEstimator {
	@Inject
	public UrbanIndexTripEstimatorVOT(TripRouter tripRouter, ActivityFacilities facilities,
