...
ggplot(combined_data, aes(x = Category, y = Count, fill = longest_distance_mode)) +
  ...
  labs(title = "Actual Mode Share vs Simulated Mode Share(SAV as Car Utility)", x = "Category", y = "Count") +
  scale_fill_brewer(palette = "Set3") +
  theme_minimal()
...
ggplot(result_df, aes(x = UrbanIndex, fill = CHOICE_FAC)) +
  ...
  labs(title = "Actual Mode Share vs Simulated Mode Share (SAV as Car Utility)", 
...
ggplot(result_df %>% filter(!is.na(longest_distance_mode)), aes(x = UrbanIndex, fill = longest_distance_mode)) +
  geom_bar(position = "fill") +
  labs(title = "Actual Mode Share vs Simulated Mode Share (SAV as Car Utility)", x = "Category", y = "Proportion") +
  scale_fill_brewer(palette = "Set3") +
  theme_minimal()
...
accessdrttrps <- result_df %>%
  filter(modes == "walk-drt-walk-pt-walk" | modes == "walk-drt-walk-pt-walk-pt-walk" | modes == "walk-pt-walk" | modes == "walk-pt-walk" | modes == "walk-pt-walk-pt-walk" )
...
ggplot(accessdrttrps, aes(x = UrbanIndex, y = time.wk, fill = CHOICE_FAC)) +
  geom_bar(stat = "identity", position = "fill") +
  scale_y_continuous(labels = scales::comma) +
  labs(title = "Actual Mode Share vs Simulated Mode Share(SAV as Car Utility)", x = "Category", y = "Count") +
  scale_fill_brewer(palette = "Set1") +
  theme_minimal()
ggplot(accessdrttrps, aes(x = UrbanIndex, y = time.wk, fill = longest_distance_mode)) +
  geom_bar(stat = "identity", position = "fill") +
  scale_y_continuous(labels = scales::comma) +
  labs(title = "Actual Mode Share vs Simulated Mode Share(SAV as Car Utility)", x = "Category", y = "Count") +
  scale_fill_brewer(palette = "Set3") +
  theme_minimal()
ggplot(accessdrttrps, aes(x = UrbanIndex, y = euclidean_distance, fill = longest_distance_mode)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::comma) +
  labs(title = "Actual Mode Share vs Simulated Mode Share(SAV as Car Utility)", x = "Category", y = "Count") +
  scale_fill_brewer(palette = "Set3") +
  theme_minimal()
ggplot(accessdrttrps, aes(x = UrbanIndex, y = euclidean_distance, fill = CHOICE_FAC)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::comma) +
  labs(title = "Actual Mode Share vs Simulated Mode Share(SAV as Car Utility)", x = "Category", y = "Count") +
  scale_fill_brewer(palette = "Set1") +
