...
public class GzipExtractor {
	...
	public static void main(String[] args) {
		String gzipFilePath = "examples/scenarios/Odakyu7/Results/configGEO_UrbanIndexDMCExtensionMAY_5/output_trips.csv.gz";
		String outputFilePath = "C:/Users/MATSIM/Downloads/trips(May55).csv";
