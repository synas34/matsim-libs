...
public class GzipExtractor {
	...
	public static void main(String[] args) {
		String gzipFilePath = "examples/scenarios/Odakyu7/Results/configGEOSIMPLE_UrbanIndexDMCExtensionSIMPLE_4/output_trips.csv.gz";
		String outputFilePath = "C:/Users/MATSIM/Downloads/trips(May35)S.csv";
