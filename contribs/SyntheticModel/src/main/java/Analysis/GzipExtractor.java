...
public class GzipExtractor {
	...
	public static void main(String[] args) {
		String gzipFilePath = "examples/scenarios/Odakyu6/configGEOSIMPLE_UrbanIndexDMCExtensionSIMPLE_3/output_trips.csv.gz";
		String outputFilePath = "C:/Users/MATSIM/Downloads/trips(May15).csv";
