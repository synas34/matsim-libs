...
public class GzipExtractor {
	...
	public static void main(String[] args) {
		String gzipFilePath = "examples/scenarios/Odakyu5/configTAXIbase_UrbanIndexDMCExtensionTAXI_LONGDIST/output_trips.csv.gz";
		String outputFilePath = "C:/Users/MATSIM/Downloads/trips(Apr19)t.csv";
